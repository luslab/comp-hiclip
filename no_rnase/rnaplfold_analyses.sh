...
# Generate RNAplfold unpaired probability metaprofile (-100nt and +100nt window)
$GITHUBDIR/get_structure_metaprofile.R --bed=$HURDIR/HuR_merged.3nt_3nt.peaks.annot.bed.gz --prob=$RESULTSDIR/hur_threeutrs.rnaplfold.bed.gz --prefix=$RESULTSDIR/hur

# Profile for shuffled control
# $GITHUBDIR/get_structure_metaprofile.R --bed=$HURDIR/HuR_merged.3nt_3nt.peaks.annot.bed.gz --prob=$RESULTSDIR/hur_threeutrs.rnaplfold.shuffled.bed.gz --prefix=$RESULTSDIR/hur_shuffled
...
# Generate RNAplfold unpaired probability metaprofile (-100nt and +100nt window)
$GITHUBDIR/get_structure_metaprofile.R --bed=$TARDPDIR/TDP43_merged.10nt_10nt.peaks.annot.bed.gz --prob=$RESULTSDIR/tdp43_threeutrs.rnaplfold.bed.gz --prefix=$RESULTSDIR/tdp43

# Profile for shuffled control
# $GITHUBDIR/get_structure_metaprofile.R --bed=$TARDPDIR/TDP43_merged.10nt_10nt.peaks.annot.bed.gz --prob=$RESULTSDIR/tdp43_threeutrs.rnaplfold.shuffled.bed.gz --prefix=$RESULTSDIR/tdp43_shuffled
