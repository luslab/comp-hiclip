...
ggsave(paste0(data.dir,"/",prefix,"_metaprofile.png"), profile.gg, width = 4, height = 4)
```
...
```{r}
plot_cluster_heatmap(prob.df, plot.title = prob.name, plot.name = paste0(data.dir,"/",prefix,"_kmeans_minus50.png"))
```
...
```{r fig3b1, fig.height = 4.5, fig.width = 1, fig.align = "center"}
clusters.gg
#ggsave(paste0(data.dir,"/",prefix,"_cluster_profiles.pdf"), clusters.gg)
#ggsave(paste0(data.dir,"/",prefix,"_cluster_profiles.png"), clusters.gg)
