...
plot_stacked_barchart <- function(data.df, column, group=NULL) {
  ...
  bar = ggplot() + geom_bar(aes(y = percentage, x = "", fill = {{column}}), data = data_counts.df,
    ...
    ggrepel::geom_text_repel(data = data_counts.df, aes(x = "", y = pos, label = paste0(round(percentage,1),"%")), size=3, nudge_x = 0.3,
...
# ggsave(paste0(data.dir, "/peak_regions.pdf"), peak_regions.gg, dpi = 300, width = 8, height = 3)
```
