...
```{r}
fwrite(stau1.duplex.span.df, paste0(data.dir,"stau1_duplex_span.tsv.gz"), sep = "\t")
```
...
mfe.dens.gg
# ggsave(paste0(data.dir, "mfe_dens.pdf"), mfe.dens.gg, dpi = 300, width = 5.2, height = 4)
```
...
```{r}
ggsave(paste0(data.dir, "paired_metric.pdf"), paired_metric.gg, dpi = 300, width = 5, height = 4)
```
...
```{r}
dplyr::filter(symmetry.df, stem_type == "Interrupted stem", bulge_count == 2)
```
