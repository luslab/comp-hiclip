...
```{r}
duplex_span.gg <- ggplot(utr3_clusters.df, aes(x = duplex_span, color = Experiment, linetype = detection_type)) + 
...
set.seed(42)
mixmdl <- normalmixEM(log10(utr3_clusters.df[utr3_clusters.df$Experiment == "STAU1" & utr3_clusters.df$detection_type == "proximity ligation" , ]$duplex_span), k = 2)
