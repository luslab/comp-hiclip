...
get_duplex <- function(region.dt, cluster_number, cores = 4) {
  ...
  #NEW
#   1
# [1]  1 15 25 34 46 55 59 68
# 2
# [1]  1  8 19 31 43 54 56 58 61
# 3
#  [1]  1  8 10 16 28 38 51 54 63 67 71
...
stau1.shuff.file <- shuff.files[str_detect(shuff.files, "stau1")]
...
stau1.prob.df$cluster <- plyr::mapvalues(stau1.prob.df$cluster, from=c(1, 2), to=c(1, 0))
...
# short range already has MFE calculated, but need the shuffled
...
```{r}
median(short_range.df$total_paired)
```
