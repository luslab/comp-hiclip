...
## Suppl. Fig 3 B: Find the optimal number of clusters:
...
stau1.cluster.hybrids.df <- stau1.hybrids.dt %>%
  mutate(cluster = case_when(sample == "stau1_nonhybrid" & !str_detect(cluster, "C") ~ name, # rename clusters for derived duplexes which havent been clustered
                             TRUE ~ cluster)) %>%
...
Number of hybrids supporting duplexes: linker vs hole atlas
