...
short_range.reformated.gc.df <- data.frame(name = arms.df$id, count = arms.df$score, L_seqnames=arms.df$fasta_id,	
...
```{r}
# Export bed file
short_range.reformated.gc.df <- data.table(short_range.reformated.gc.df)
export_genomic_bed(short_range.reformated.gc.df, paste0(data.dir, "/predicted_duplexes.bed"))
