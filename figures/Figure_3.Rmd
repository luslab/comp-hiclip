...
```{r}
# Density plot
mfe.df <- pivot_longer(mfe, cols = c(mfe, mean_shuffled_mfe), names_to = "Sample", values_to = "MFE")
...
```{r}
mfe.dens.gg <- ggplot(mfe.df, aes(x = MFE, linetype = Sample)) + 
  geom_density(alpha = 0.8, color = "#31a1b3") +
...
mfe.dens.gg
ggsave(paste0(plots.dir,"/","stau1_short_range_hybridisation_energy.pdf"), mfe.dens.gg, width = 5, height = 4)
```
