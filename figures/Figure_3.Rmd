...
# arf1_stau1.dt$q <- 0
# arf1_stau1.bp.dt <- arf1_stau1.dt[, .(L_genomic_seqnames, L_genomic_start, L_genomic_end, R_genomic_start, R_genomic_end, q)]

# fwrite(arf1_stau1.bp.dt, sep = "\t", col.names = FALSE, file ="~/Dropbox (The Francis Crick)/comp_hiclip/short_range/sept_2021/arf1_structures.bp")
# dplyr::filter(arf1_stau1.dt, name %in% "ID2361")
arf1_stau1.dt
```
